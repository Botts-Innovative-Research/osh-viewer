...
var YUVCanvas = /** @class */ (function () {
    ...
    YUVCanvas.prototype.init = function () {
         ...
         */
        if (this.type === "yuv420") {
            this.drawNextOutputPictureGL = function (par) {
            ...
            this.drawNextOutputPictureBitmapGL = function (par) {
                var gl = _this.contextGL;
                var texturePosBuffer = _this.texturePosBuffer;
                var yTextureRef = _this.yTextureRef;
                var yData = par.yData;
     ...
     */
    YUVCanvas.prototype.drawNextOutputPictureRGBA = function (width, height, croppingParams, data) {
        var canvas = this.canvasElement;
        var argbData = data;
