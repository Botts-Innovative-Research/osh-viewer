...
const API = {
    ...
    systems: {
        ...
        control_by_id: '/systems/{sysid}/controlstreams/{dsid}',
    ...
    controls: {
        ...
        commands: '/systems/{sysid}/controlstreams/{dsid}/commands',
        command_by_id: '/systems/{sysid}/controlstreams/{dsid}/commands/{cmdid}',
        status: '/systems/{sysid}/controlstreams/{dsid}/status',
        schema: '/systems/{sysid}/controlstreams/{dsid}/schema'
    },
    commands: {
        // status: '/systems/{sysid}/controls/{dsid}/commands/{cmdid}/status'
        status: '/systems/{sysid}/controlstreams/{dsid}/commands/{cmdid}/status'        
    },
    observations: {
        search: '/observations',
