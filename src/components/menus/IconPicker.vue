...
watch([selectedIcon, selectedRgbaColor], () => {
  ...
  <div>
    ...
    <div style="display: flex; gap: 10px; flex-wrap: wrap;">
      <div 
        ...
        :key="icon.name" @click="selectIcon(icon)" style="cursor: pointer; border: 1px solid #ccc; padding: 5px; border-radius: 4px;">
         <div v-html="icon.svg" style="width: 32px; height: 32px;"></div>
      </div>
    </div>
    <div v-if="selectedIcon" style="margin-top: 20px;">
      <h4>Selected Icon:</h4>
       <div v-html="selectedIcon.svg.replace(/CURRENT_COLOR/g, `rgba(${selectedRgbaColor.r}, ${selectedRgbaColor.g}, ${selectedRgbaColor.b}, ${selectedRgbaColor.a})`)" style="width: 64px; height: 64px;"></div>
    </div>
    <v-color-picker
        style="margin: auto;" 
