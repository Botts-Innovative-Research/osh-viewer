...
<template>
  ...
  <v-select v-model="selectedDatastreams" :items="listDatastreams" hint="Select one or more datastreams"
    label="Select datastream(s)" multiple persistent-hint item-title="name" :item-value="(item: OSHDatastream) => item"></v-select>
</template>