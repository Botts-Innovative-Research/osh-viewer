...
<template>
	...
	<v-container>
		<v-checkbox
			label="Home Location"
			v-model="checkedRoles.home"
			disabled
		></v-checkbox>
		<DataSourcePicker
			v-if="checkedRoles.home"
			role="home"
			:show-property-selector="false"
			v-model:valid="homeValid"
		/>
	</v-container>
	...
	<v-container>
		<v-checkbox
			...
			v-model="checkedRoles.takeoff"
		></v-checkbox>
		<ControlStreamPicker
			v-if="checkedRoles.takeoff"
			role="takeoff"
			:show-property-selector="false"
	...
	<v-container>
		<v-checkbox
			label="Land Mission"
			v-model="checkedRoles.land"
		></v-checkbox>
		<ControlStreamPicker
			v-if="checkedRoles.land"
			role="land"
			:show-property-selector="false"
	...
	<v-container>
		<v-checkbox
			label="Pause Mission"
			v-model="checkedRoles.pause"
		></v-checkbox>
		<ControlStreamPicker
			v-if="checkedRoles.pause"
			role="pause"
			:show-property-selector="false"
	...
	<v-container>
		<v-checkbox
			...
			v-model="checkedRoles.rtl"
		></v-checkbox>
		<ControlStreamPicker
			v-if="checkedRoles.rtl"
			role="rtl"
			:show-property-selector="false"
			v-model:valid="rtlValid"
		/>
	</v-container>
	...
	<v-container>
		<v-checkbox
			...
			v-model="checkedRoles.offboard"
		></v-checkbox>
		<ControlStreamPicker
			v-if="checkedRoles.offboard"
			role="offboard"
			:show-property-selector="false"
